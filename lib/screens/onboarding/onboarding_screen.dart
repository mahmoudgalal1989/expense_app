      ...
      final shader = ui.Gradient.radial(
        ...
        [
          const Color(0xFF008AFF)
              .withOpacity(0.75 * s.intensity), // Inner gradient start
          const Color(0xFF00A1FF)
              .withOpacity(0.5 * s.intensity), // Mid gradient
          const Color(0xFF00A1FF)
              .withOpacity(0.25 * s.intensity), // Outer gradient
          Colors.transparent,
        ],
...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  void initState() {
    ...
    _imageController = AnimationController(
      duration:
          const Duration(milliseconds: 500), // Smooth 500ms image transitions
      vsync: this,
    );
        ...
        if (_currentStep == 3 && !_isAnimating) {
          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                bottom:
                    0, // At container bottom, now touches header since spacer removed
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(16),
                  child: Image.asset(
        ...
        if (_currentStep == 3 && _isAnimating) {
          return Stack(
            ...
            children: [
              ...
              Transform.translate(
                offset: Offset(
                    0, -_imageController.value * 200), // Slide up and out
                child: Opacity(
                  opacity: (1.0 - _imageController.value)
                      .clamp(0.0, 1.0), // Fade out from 1.0 to 0.0
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(16),
                    child: Image.asset(
              ...
              Positioned(
                top: 75 -
                    (55 *
                        _imageController
                            .value), // From 75px to 20px (maintains overlap)
                child: Opacity(
              ...
              Positioned(
                bottom:
                    0, // Match static position - touches header with spacer removed
                child: Opacity(
                  opacity: _imageController.value,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(16),
              ...
              Transform.translate(
                offset: Offset(
                    ...
                    50 *
                        (1 -
                            _imageController
                                .value)), // Slide up from 50px below
                child: Opacity(
                  opacity: _imageController
                      .value, // Opacity increases as it slides up
                  child: Transform.scale(
                    scale: 0.95 +
                        (0.05 *
                            _imageController
                                .value), // Subtle scale from 0.95 to 1.0
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(16),
                      child: Image.asset(
  ...
  Future<void> _completeOnboarding() async {
    ...
    const targetScreen =
        FeatureFlags.showInsightsScreen ? InsightsScreen() : CurrencyScreen();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RepaintBoundary(
                            child: SizedBox(
                              height:
                                  500, // Increased to accommodate extended positioning (-50px top/bottom)
